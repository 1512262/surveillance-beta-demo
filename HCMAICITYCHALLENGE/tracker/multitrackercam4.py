...
import cv2
from utils.bb_polygon import check_bbox_intersect_or_outside_polygon,check_bbox_outside_polygon,counting_moi,point_to_line_distance,check_bbox_inside_polygon,tlbrs_to_mean_area
...
class JDETracker(object):
    def __init__(self, opt,polygon, paths, frame_rate=30):
        self.opt = opt
        if opt.gpus[0] >= 0:
