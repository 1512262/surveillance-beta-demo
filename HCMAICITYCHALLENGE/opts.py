...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--input-video', type=str, default='TestSet/cam_09.mp4', help='path to the input video')
    self.parser.add_argument('--input-meta', type=str, default='TestSet/zones-movement_paths/cam_09.json', help='path to the polygon and moi of video')

    self.parser.add_argument('--output-format', type=str, default='video', help='video or text')
    self.parser.add_argument('--output-root', type=str, default='results/cam_09', help='expected output root path')
    self.parser.add_argument('--compound_coef', type=int, default=7, help='compound_coef of efficientdet')
